...
<title>Checkout Shopping Cart - Online Bookstore</title>
...
<body>
	...
	<div align="center">
		...
		<c:if test = "${cart.totalItems > 0}"> 
				<div>
					<h2> Review your Order Details<a href="view_cart">Edit Your Order</a></h2>
						...
						<table border="1">
							...
							<tr>
								...
								<td>Total:</td>
								<td colspan="4"><fmt:formatNumber value="${cart.totalAmount}" type="currency"/></td>
							</tr>
						</table>
