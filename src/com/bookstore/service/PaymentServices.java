...
public class PaymentServices {
		private static final String CLIENT_ID = "AfukfDps7a90-0ZLWvLKkDWSFxP87Dsq4HbKtAdTnoFuV2z5ytG0IZ4bVxTlRnnYxA2VAq-YGOIjIaEs";
		private static final String CLIENT_SECRET = "EJ83q_V7pXVoEjkCj_YrkYHV8WkYe3YA-aF95DCHmXhS_yKWm0M4zXLMw84KFd7H1yPZmM0TOeL7ocha";
		...
		private Amount getAmountDetails(BookOrder order) {
			...
			details.setSubtotal(String.format("%.2f", order.getOrderSubTotal()));
		...
		private List<Transaction> getTransactionInformation(BookOrder order) {
			...
			transaction.setDescription("Z-Squared BookStore Tutorial");
